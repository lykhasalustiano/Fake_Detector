...
class ArticleDetailWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        source_label.setStyleSheet("font-size: 14px; color: #666; font-weight: bold;")
        
        status_label = QLabel(f"Status: {self.article_data.get('Fake_News_Label', '❓ UNKNOWN')}")
        status_label.setStyleSheet("font-size: 14px; font-weight: bold; color: #d32f2f;")
        ...
        meta_frame.setStyleSheet("background-color: #f9f9f9; border: 1px solid #ddd; padding: 10px;")
        ...
        for label in [date_label, author_label, url_label]:
            label.setStyleSheet("margin: 5px; font-size: 12px;")
        ...
        content_label.setStyleSheet("font-size: 16px; font-weight: bold; margin-top: 10px;")
        ...
        # Back button
        back_button = QPushButton("← Back to Articles")
...
class SereniTruthApp(QMainWindow):
    ...
    def display_articles(self):
        ...
        if self.current_filter == "all":
            filtered_articles = self.articles_data
        elif self.current_filter == "fake":
            filtered_articles = [article for article in self.articles_data 
        ...
        for article in filtered_articles:
            ...
            title = f"[{article.get('Source', 'Unknown')}] {article.get('Title', 'No Title')} - {status}"
